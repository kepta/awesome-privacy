...
- [Nextcloud](https://nextcloud.com/) - The open source self-hosted productivity platform that keeps you in control. It has a _[Photos](https://github.com/nextcloud/photos)_ plugin to help you organize and visualize your photos.
